...
const initialLocale = savedLocale === "es" || savedLocale === "en" ? savedLocale : "es";
...
const translations = {
  es: {
    ...
    validation: {
      ...
      passwordRules: "Debe tener 8-20 caracteres, mayúscula, minúscula y un número",
      passwordsMismatch: "Las contraseñas no coinciden",
      termsRequired: "Debes aceptar los Términos y Condiciones y la Política de Datos"
    },
    login: {
      greeting: "¡Hola de nuevo!",
      subtitle: "Inicia sesión para continuar tu viaje hacia el bienestar y la productividad.",
    ...
    register: {
      ...
      subtitle: "Únete a FocusFlow y empieza a transformar tu productividad y bienestar.",
      ...
      termsText: "Acepto los Términos y Condiciones, la Política de Datos y autorizo el uso de mis datos sensibles para las finalidades de la App.",
    ...
    forgotPassword: {
      ...
      subtitle: "Ingresa tu correo electrónico y si el correo existe, recibirás un enlace para crear una nueva contraseña.",
      emailPlaceholder: "Ingresa tu correo electrónico"
    },
    updatePassword: {
    ...
    welcome: {
      ...
      subtitle: "Tu cuenta está lista. Ahora puedes empezar a administrar tareas, bienestar y objetivos.",
    ...
    adminPanel: {
      ...
      manageTasks: "Gestiona tus propias tareas, pomodoros y registros de energía.",
      attendPqrs: "Atender PQRs",
      createAccounts: "Crea nuevas cuentas para el equipo de soporte o administración."
    },
    support: {
      title: "Soporte y PQRs",
      description: "Administra y da seguimiento a todos los tickets del sistema de forma rápida y ordenada.",
      category: "Categoría",
      priority: "Prioridad",
    ...
    focus: {
      ...
      noMatchingTasks: "No hay tareas que coincidan",
      errorSave: "Error al guardar la sesión"
    },
    wellness: {
      title: "Bienestar"
    },
    ...
    terms: {
      ...
      intro: "Al registrarse y utilizar la aplicación FocusFlow, el usuario acepta estos Términos y Condiciones, así como la Política de Datos.",
    ...
    dataPolicy: {
      ...
      collectedData: "Los datos personales que recolectamos (Nombre, correo electrónico, registros de actividad, estado de ánimo y hábitos de bienestar).",
      management: "Gestión del Servicio: Crear y administrar la cuenta del usuario.",
      personalization: "Personalización: Generar diagnósticos de bienestar y recomendaciones de productividad.",
      support: "Soporte: Atender peticiones, quejas, reclamos y sugerencias (PQRS).",
      security: "Seguridad: Procesar pagos de suscripciones a través de pasarelas seguras.",
      withdrawal: "Retirar la autorización de tratamiento en cualquier momento.",
      request: "Solicitar prueba de la autorización otorgada a FocusFlow.",
      sensitiveData: "FocusFlow recolecta datos sobre el estado de ánimo, niveles de estrés y hábitos de bienestar."
    },
    onboarding: {
      title: "Cuestionario inicial",
      description: "Este cuestionario inicial nos ayudará a ofrecerte herramientas ajustadas a tus objetivos.",
      categories: {
        tasks: "Tareas",
    ...
    adjustPlan: {
      ...
      dailyFocusQuestion: "¿Cuántas tareas prioritarias quieres completar cada día?",
      saveChanges: "Guardar Cambios",
      saving: "Guardando..."
    },
    mood: {
    ...
    dashboard: {
      ...
      energyDescription: "Registra tu energía y tu estado emocional con estilo y claridad.",
      ...
      optionalPlaceholder: "Describe brevemente cómo te sientes o qué influye en tu día.",
    ...
    tasks: {
      ...
      deleteModalMessage: "¿Estás seguro de que deseas eliminar la tarea \"{task}\"? Esta acción no se puede deshacer.",
      cancel: "Cancelar",
    ...
    wellness: {
      title: "Bienestar",
      subtitle: "Encuentra tu equilibrio con ejercicios de respiración, pausas activas y meditaciones guiadas.",
      ...
      activeBreaksDesc: "Activa tu cuerpo y despeja tu mente con movimientos ligeros.",
      applyButton: "Aplicar"
    },
    transactions: {
      title: "Finanzas",
  ...
  en: {
    ...
    validation: {
      ...
      passwordRules: "Must have 8-20 characters, uppercase, lowercase and a number",
      passwordsMismatch: "Passwords do not match",
      termsRequired: "You must accept the Terms and Conditions and Privacy Policy"
    },
    login: {
      greeting: "Welcome back!",
      subtitle: "Log in to continue your journey toward wellbeing and productivity.",
    ...
    register: {
      ...
      subtitle: "Join FocusFlow and start transforming your productivity and wellbeing.",
      ...
      termsText: "I accept the Terms and Conditions, the Privacy Policy and authorize the use of my sensitive data for App purposes.",
    ...
    forgotPassword: {
      ...
      subtitle: "Enter your email and if the address exists, you will receive a link to create a new password.",
      emailPlaceholder: "Enter your email"
    },
    updatePassword: {
      title: "Create a new password",
      subtitle: "Choose a secure and unique password different from your previous one.",
    ...
    welcome: {
      ...
      subtitle: "Your account is ready. You can now start managing tasks, wellbeing, and goals.",
    ...
    terms: {
      ...
      intro: "By registering and using FocusFlow, the user accepts these Terms and Conditions as well as the Privacy Policy.",
    ...
    dataPolicy: {
      ...
      collectedData: "Personal data collected (Name, email, activity logs, mood and wellness habits).",
      management: "Service Management: Create and manage the user account.",
      personalization: "Personalization: Generate wellbeing diagnostics and productivity recommendations.",
      support: "Support: Attend requests, complaints, claims and suggestions (PQRs).",
      security: "Security: Process subscription payments through secure gateways.",
      ...
      sensitiveData: "FocusFlow collects data about mood, stress levels and wellness habits."
    },
    onboarding: {
      title: "Initial questionnaire",
      description: "This initial questionnaire will help us offer tools tailored to your goals.",
      categories: {
        tasks: "Tasks",
    ...
    adjustPlan: {
      ...
      dailyFocusQuestion: "How many priority tasks do you want to complete each day?",
      saveChanges: "Save changes",
      saving: "Saving..."
    },
    mood: {
    ...
    dashboard: {
      ...
      energyDescription: "Record your energy and emotional state with style and clarity.",
      ...
      optionalPlaceholder: "Briefly describe how you feel or what influences your day.",
    ...
    tasks: {
      ...
      deleteModalMessage: "Are you sure you want to delete the task \"{task}\"? This action cannot be undone.",
      cancel: "Cancel",
      addTask: "Add task",
    ...
    wellness: {
      title: "Wellness",
      subtitle: "Find your balance with breathing exercises, active breaks and guided meditations.",
      ...
      activeBreaksDesc: "Get your body moving and clear your mind with light movement.",
      applyButton: "Apply"
    },
    transactions: {
      title: "Finances",
...
export const localeCode = computed(() => (locale.value === "en" ? "en-US" : "es-CO"));
