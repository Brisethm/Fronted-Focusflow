        ...
        <div class="flex flex-col min-h-screen justify-between">
            <main class="flex-grow">
                <header class="flex items-center justify-between p-4 bg-background-light dark:bg-background-dark">
                    <button class="text-content-light dark:text-content-dark">
                    ...
                    <h1 class="text-lg font-bold text-content-light dark:text-content-dark">Resumen</h1>
                    <button class="text-content-light dark:text-content-dark">
                        <svg class="icon" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
                            <path
                ...
                <div class="px-4 pb-8 space-y-6">
                    <section class="p-4 rounded-lg bg-background-light dark:bg-background-dark shadow-sm">
                        <h2 class="text-xl font-bold text-content-light dark:text-content-dark mb-4">¿Cómo te sientes
                            hoy?</h2>
                        <div class="space-y-6">
                            <div>
                                <label class="block font-medium text-content-light dark:text-content-dark mb-2"
                                    for="energy-level">Nivel de Energía</label>
                                <div class="relative">
                                    <input
                                        class="w-full h-2 bg-border-light dark:bg-border-dark rounded-lg appearance-none cursor-pointer"
                                        id="energy-level" max="5" min="1" name="energy" type="range" value="1" />
                                </div>
                            ...
                            <div>
                                <label class="block font-medium text-content-light dark:text-content-dark mb-3">Estado
                                    de Ánimo</label>
                                <div class="grid grid-cols-5 gap-2 text-center">
                                    <button
                                        class="flex flex-col items-center gap-1.5 p-2 rounded-lg bg-primary/10 dark:bg-primary/20 text-primary">
                                        <span class="text-2xl">😊</span>
                                        <span class="text-xs font-medium">Feliz</span>
                                    </button>
                                    <button
                                        class="flex flex-col items-center gap-1.5 p-2 rounded-lg text-subtle-light dark:text-subtle-dark hover:bg-gray-100 dark:hover:bg-white/5">
                                        <span class="text-2xl">😌</span>
                                        <span class="text-xs font-medium">Calmado</span>
                                    </button>
                                    <button
                                        class="flex flex-col items-center gap-1.5 p-2 rounded-lg text-subtle-light dark:text-subtle-dark hover:bg-gray-100 dark:hover:bg-white/5">
                                        <span class="text-2xl">😟</span>
                                    ...
                                    <button
                                        class="flex flex-col items-center gap-1.5 p-2 rounded-lg text-subtle-light dark:text-subtle-dark hover:bg-gray-100 dark:hover:bg-white/5">
                                        <span class="text-2xl">😠</span>
                                        <span class="text-xs font-medium">Enojado</span>
                                    </button>
                                    <button
                                        class="flex flex-col items-center gap-1.5 p-2 rounded-lg text-subtle-light dark:text-subtle-dark hover:bg-gray-100 dark:hover:bg-white/5">
                                        <span class="text-2xl">😥</span>
                    ...
                    <section>
                        ...
                        <div class="space-y-3">
                            <div
                                ...
                                <div class="flex-1">
                                    <p class="font-medium text-content-light dark:text-content-dark">Revisar el informe
                                        de marketing</p>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <p class="font-medium text-content-light dark:text-content-dark">Llamada con el
                                        equipo de ventas</p>
                            ...
                            <div
                                ...
                                <div class="flex-1">
                                    <p class="font-medium text-content-light dark:text-content-dark">Preparar la
                                        presentación del cliente</p>
                    ...
                    <section>
                        <h2 class="text-xl font-bold text-content-light dark:text-content-dark mb-4">Progreso</h2>
            ...
            <footer
                class="sticky bottom-0 bg-background-light dark:bg-background-dark border-t border-border-light dark:border-border-dark">
...
<script setup>
// Importamos ref para estados reactivos
import { ref } from 'vue'
import "../styles/dashboard.css"

// Ejemplo de estado
const mensaje = ref('Hola desde la vista')
