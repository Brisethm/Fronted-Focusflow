<template>
    <div class="bg-background-light dark:bg-background-dark font-display h-screen flex overflow-hidden">
                    ...
                    <svg aria-hidden="true" class="w-24 h-24 text-pink-400" fill="none" viewBox="0 0 100 100"
                        ...
                        <g transform="translate(50,50)">
                            <path d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                                fill="url(#petalGradient)"></path>
                            <path d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                                fill="url(#petalGradient)" transform="rotate(72)"></path>
                            <path d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                                fill="url(#petalGradient)" transform="rotate(144)"></path>
                            <path d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                                fill="url(#petalGradient)" transform="rotate(216)"></path>
                            <path d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                                fill="url(#petalGradient)" transform="rotate(288)"></path>
                        </g>
        ...
        <div class="hidden md:flex w-1/2 items-center justify-center bg-gray-100 dark:bg-gray-900 h-full">
            <img :src="updatePasswordIllustration" alt="Imagen de Freepik" class="max-w-full h-auto" />
        </div>
    </div>
</template>
