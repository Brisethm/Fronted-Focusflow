  ...
  <div class="bg-background-light dark:bg-background-dark font-display">
    ...
    >
      <div class="flex-grow">
        ...
        >
          <button class="text-slate-800 dark:text-slate-200">
            <span class="material-symbols-outlined text-3xl">menu</span>
          </button>
          <h1
            class="flex-1 text-center text-lg font-bold text-slate-900 dark:text-white pr-8"
          >
            Bienestar
          </h1>
        </header>
        ...
        <main class="p-4 sm:p-6">
          ...
          <div class="space-y-8">
              ...
              <div class="space-y-4">
                ...
                >
                  ...
                  <div class="flex items-center gap-4">
                    ...
                    <!-- Botón que cambia de Play a Cerrar -->
                    <button 
                  ...
                  <!-- Contenedor del Video (Se muestra al hacer clic) -->
                  <div 
            ...
            <!-- Sección de Meditaciones Guiadas -->
            <section>
              <h3 class="text-xl font-bold text-slate-900 dark:text-white mb-4">
              ...
              <div class="space-y-4">
                ...
                >
                  <div
                    class="h-24 w-24 flex-shrink-0 rounded-lg bg-cover bg-center"
                    style="background-image: url('https://lh3.googleusercontent.com/aida-public/AB6AXuBL_GhmgafrW129CM-Ux5j5wWTs2zBCuE-O-AWc0xOzTD3XrzouadTz3h43yChKPVwg66iuem--WmFVeh94XSgG2gdoQOb0D1rFoAcF62H3d8qjRxpc-XJV2Q97hk-7ZAfLNmZ2N6wa-Hp30ooEKGav9p0saaqsWpwaC9lrRlJcFwoen7JZ8n5uPzWzzP5axzcQ0-LauEAx_wId6RGw9yGql4vQmqMidkeE2Vl6O6MC9PU3K6W0hea3HsJH3KK88nYKU8KhMQCCVDnS');"
                  ></div>
                  <div class="flex-1">
                    <p class="text-sm font-medium text-primary">20 minutos</p>
                    <p class="text-base font-bold text-slate-800 dark:text-slate-100">
                      Atención plena
                    </p>
                    <p class="text-sm text-slate-500 dark:text-slate-400">
      ...
      <!-- Navegación Inferior -->
      <nav
        class="sticky bottom-0 z-10 border-t border-slate-200 bg-background-light/90 backdrop-blur-sm dark:border-slate-800 dark:bg-background-dark/90"
      >
        <div class="flex justify-around px-2 pt-2 pb-4">
          ...
          <a class="flex flex-col items-center gap-1 text-primary" href="#">
            ...
            <span class="text-xs font-bold">Bienestar</span>
          </a>
          <a class="flex flex-col items-center gap-1 text-slate-500 dark:text-slate-400" href="#">
...
// Estado para controlar la visibilidad del video de "La Caja"
const mostrarVideoCaja = ref(false);

// Ejemplo de estado y función (puedes adaptarlo o borrarlo según necesites)
const mensaje = ref("Bienvenido a FocusFlow Bienestar");
