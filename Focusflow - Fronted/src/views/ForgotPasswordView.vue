<template>
  <div
    class="bg-background-light dark:bg-background-dark font-display h-screen flex overflow-hidden"
  >
    <div
      class="flex flex-col items-center w-full md:w-1/2 px-4 md:px-8 lg:px-16 overflow-y-auto py-4"
    >
      <div
        class="flex flex-col items-center text-center mb-6 w-full max-w-sm mt-2"
      >
        <div class="w-32 h-24 mb-2">
          ...
          >
            ...
            <g transform="translate(50,50)">
              <path
                d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                fill="url(#petalGradientPurple)"
              ></path>
              <path
                d="M0 -45 C 25 -45, 25 -15, 0 -15 C -25 -15, -25 -45, 0 -45 Z"
                fill="url(#petalGradientPurple)"
        ...
        <p class="text-base text-gray-600 dark:text-gray-300">
          Ingresa tu correo electrónico y si el correo existe, recibirás un
      ...
      <!-- Formulario de reset -->
      <form
        class="w-full max-w-sm text-left mb-4"
      ...
      >
        ...
        >
          ...
          <span v-else-if="resendTimer > 0"
            >Reenviar en {{ resendTimer }}s</span
          >
          <svg
            v-else
    ...
    <div
      class="hidden md:flex w-1/2 items-center justify-center bg-gray-100 dark:bg-gray-900 h-full"
    >
      <img
        :src="forgotPasswordIllustration"
        alt="Tomado de Freepik"
